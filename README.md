<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&width=435&lines=The+five+boxing+wizards+jump+quickly" alt="Typing SVG" /></a>##💻 Code • Learn • Build • Innovate

class ShreyaChavan():

    def __init__(self):
        self.name = "Shreya Chavan"
        self.role = "AI/ML Engineer"
        self.education = "B.Tech Computer Science (AI & ML)"
        self.company = "Associate Full Stack Developer @ Cogitate Technology Solutions"
        self.location = "India"
